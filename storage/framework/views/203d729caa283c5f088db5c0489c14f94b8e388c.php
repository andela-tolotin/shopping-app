...
<!-- Tooltipster -->
<script src="<?php echo e(asset('js/vendor/jquery.tooltipster.min.js')); ?>"></script>
<!-- Owl Carousel -->
<script src="<?php echo e(asset('js/vendor/owl.carousel.min.js')); ?>"></script>
<script src="<?php echo e(asset('js/vendor/imgLiquid-min.js')); ?>"></script>
<script src="<?php echo e(asset('js/liquid.js')); ?>"></script>
<!-- Magnific Popup -->
...
<script src="<?php echo e(asset('js/vendor/jquery.xmaccordion.min.js')); ?>"></script>
<!-- XM Pie Chart -->
<script src="<?php echo e(asset('js/vendor/jquery.xmpiechart.min.js')); ?>"></script>
<!-- Product Page -->
<script src="<?php echo e(asset('js/product-page.js')); ?>"></script>
<!-- Tooltip -->
