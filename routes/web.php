...
Route::get('/', 'HomeController@listProducts')->name('home');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    //pointWallet
    Route::get('/notifications', 'NotificationContoller@loadNotification')->name('view_notification');
    Route::get('/read-all/notifications', 'NotificationContoller@readNotifications')->name('mark_all_notification');
});
